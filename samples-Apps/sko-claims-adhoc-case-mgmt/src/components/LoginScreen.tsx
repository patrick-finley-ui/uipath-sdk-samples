...
export const LoginScreen = ({
  appName = 'SKO Claims Adhoc Case Management',
  appDescription = 'Manage claims and case workflows',
  detailedDescription = 'Access the claims management system to review, process, and track claims through automated workflows.',
}: LoginScreenProps = {}) => {
