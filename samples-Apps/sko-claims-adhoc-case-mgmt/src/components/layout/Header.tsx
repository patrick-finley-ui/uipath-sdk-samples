      ...
      <div className="px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 bg-uipath-orange rounded-lg flex items-center justify-center">
              <span className="text-white font-bold text-xl">SKO</span>
            </div>
            <div className="hidden md:block">
              <h1 className="text-xl font-semibold text-gray-900">Claims Management Portal</h1>
              <p className="text-xs text-gray-500">Personal Injury Claims System</p>
            </div>
          </div>
            ...
            {sdk?.isAuthenticated() && (
              <div className="flex items-center gap-3">
                <div className="hidden sm:flex flex-col items-end">
                  ...
                  <span className="text-xs text-gray-500">Claims Adjuster</span>
                </div>
