interface LoanProgressBarProps {
  currentStage: number; // 0-3 (0 = Intake, 1 = Risk Assessment, 2 = Eligibility Analysis, 3 = Close & Notify)
}

const stages = [
  'Intake and Document Collection',
  'Risk Assessment',
  'Eligibility Analysis & determination',
  'Close & Notify',
];

export const LoanProgressBar = ({ currentStage }: LoanProgressBarProps) => {
  return (
