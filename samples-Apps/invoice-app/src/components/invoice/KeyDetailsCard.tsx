    ...
    <div className="bg-white rounded-lg p-4 shadow-sm border border-gray-200">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        {selectedInvoice.remarks && (
          <div className="col-span-2">
            <span className="text-base text-gray-500 block mb-1">Remarks</span>
            <p className="text-base text-gray-900 leading-relaxed whitespace-pre-wrap">{selectedInvoice.remarks}</p>
          </div>
        )}
